            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-gray-50 rounded-xl p-6 border border-gray-100 hover:border-emerald-600/30 hover:shadow-md transition flex flex-col justify-between">
                    ...
                    <div class="border-t border-gray-200/60 pt-4 mt-2">
                        ...
                        <div class="flex flex-wrap gap-1.5 text-[10px] font-medium text-gray-600">
                            <span class="bg-gray-200 px-2 py-0.5 rounded">Fathul Qorib</span>
                            <span class="bg-gray-200 px-2 py-0.5 rounded">Nahwu Sharaf Dasar</span>
                            <span class="bg-gray-200 px-2 py-0.5 rounded">Imriti</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 rounded-xl p-6 border border-gray-100 hover:border-emerald-600/30 hover:shadow-md transition flex flex-col justify-between">
                    ...
                    <div class="border-t border-gray-200/60 pt-4 mt-2">
                        <span class="text-[11px] font-semibold text-gray-500 uppercase block mb-1">Fokus Utama:</span>
                        <div class="flex flex-wrap gap-1.5 text-[10px] font-medium text-gray-600">
                            <span class="bg-gray-200 px-2 py-0.5 rounded">Alfiyah Ibnu Malik</span>
                            <span class="bg-gray-200 px-2 py-0.5 rounded">Balaghah</span>
                            <span class="bg-gray-200 px-2 py-0.5 rounded">B. Arab Aktif</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 rounded-xl p-6 border border-gray-100 hover:border-emerald-600/30 hover:shadow-md transition flex flex-col justify-between">
                    ...
                    <div class="border-t border-gray-200/60 pt-4 mt-2">
                        <span class="text-[11px] font-semibold text-gray-500 uppercase block mb-1">Fokus Utama:</span>
                        <div class="flex flex-wrap gap-1.5 text-[10px] font-medium text-gray-600">
                            <span class="bg-gray-200 px-2 py-0.5 rounded">Ziyadah (Setoran)</span>
                            <span class="bg-gray-200 px-2 py-0.5 rounded">Murajaah Kuat</span>
                            <span class="bg-gray-200 px-2 py-0.5 rounded">Matan Jazariyah</span>
                        </div>
                    </div>
                </div>
            </div>

            {{-- INTEGRASI SAKLAR FITUR: DOWNLOAD BROSUR KURIKULUM PDF --}}
            @if($setting->feature_download)
            <div class="mt-12 p-6 bg-slate-50 rounded-xl border border-gray-200 flex flex-col sm:flex-row justify-between items-center gap-4 max-w-3xl mx-auto shadow-sm">
                ...
                @else
                    <a href="#" onclick="alert('File berkas silabus PDF belum diunggah oleh Admin.'); return false;" class="bg-gray-400 text-white text-xs font-semibold px-4 py-2.5 rounded transition whitespace-nowrap shadow-sm cursor-not-allowed">
